...
this is a replication of anthropic's paper on monosemanticity https://transformer-circuits.pub/2023/monosemantic-features i played around with residual stream activations instead of mlp activations to see if anything cool shows up
